...
export default function AllMenu() {
  return (
    <div className="all_menu">
      <div className="all_menu_header"></div>
      <div className="all_menu_wrap scrollbar">
        <div className="all_left">
          <div className="all_menu_search">
            <i className="amm_s_icon"></i>
            <input type="text" className="" placeholder="Search Menu" />
          </div>
        ...
        <div className="all_right">
          ...
          {create.map((item) => (
            <div className="all_right_item hover1" key={item.name}>
